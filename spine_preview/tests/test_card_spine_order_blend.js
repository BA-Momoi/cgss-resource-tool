// 验证: 5 个 skel 按 bg->chara->eff1->eff2->fg 排序, 以及 additive/multiply 混合模式切换。
const fs = require('fs');
...
function priority(name) {
  ...
  if (s.indexOf('chara') >= 0) return 1;
  if (s.indexOf('eff1') >= 0) return 2;
  if (s.indexOf('eff2') >= 0) return 3;
...
const expected = ['SP3S301290_bg.skel.asset', 'SP3S301290_chara.skel.asset',
                  'SP3S301290_eff1.skel.asset', 'SP3S301290_eff2.skel.asset',
